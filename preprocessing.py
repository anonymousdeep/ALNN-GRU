...
prior_hours=48
chartevents=pd.read_csv(f'../data/chartevents_{prior_hours}_imputed.csv',low_memory=False,engine='c')
icustays=pd.read_csv('../data/ICUSTAYS.csv',low_memory=False,engine='c')
admissions=pd.read_csv('../data/ADMISSIONS.csv',low_memory=False,engine='c')
d_items=pd.read_csv('../data/D_ITEMS.csv',engine='c',low_memory=False)
...
pd.DataFrame(data=Time_.reshape(-1,stream_length*len(features))).to_csv(f'../data/time_{prior_hours}_{stream_length}_padded_imputed.csv',index=False)
pd.DataFrame(data=M_.reshape(-1,stream_length*len(features))).to_csv(f'../data/mask_{prior_hours}_{stream_length}_padded_imputed.csv',index=False)
pd.DataFrame(data=X_.reshape(-1,stream_length*len(features))).to_csv(f'../data/values_{prior_hours}_{stream_length}_padded_imputed.csv',index=False)
pd.DataFrame(data=y.reshape(-1)).to_csv(f'../data/target_{prior_hours}_{stream_length}_padded_imputed.csv',index=False)
