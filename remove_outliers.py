...
icu_stays=pd.read_csv('data/ICUSTAYS.csv',low_memory=False,engine='c')
icu_stays.head(3)
...
chartevents=pd.read_csv('data/charevents_sorted.csv',low_memory=False,engine='c')
chartevents.head(3)
...
outputevents=pd.read_csv('data/outputevents_sorted.csv',low_memory=False,engine='c')
outputevents.head(3)
...
chartevents=chartevents[['SUBJECT_ID','HADM_ID','ICUSTAY_ID','ITEMID','CHARTTIME','VALUENUM']]
chartevents.head(2)
...
crr_dataframe=crr_dataframe[['SUBJECT_ID','HADM_ID','ICUSTAY_ID','ITEMID','CHARTTIME','VALUE']]
...
chartevents.to_csv(f'data/chartevents_{prior_hours*24}.csv',index=False)